//! Everything a caller supplies to a send or reply, and the rules it has to
//! pass before anything is uploaded or queued. Every problem is reported at
...
use crate::mail::{
    ...
    HEADERS_BUDGET, MAX_OUTBOUND_DECODED_BYTES, OUTBOUND_RECIPIENTS_MAX, SUBJECT_MAX_BYTES,
};
